...
if __name__ == "__main__":
    ...
    # pixel spacing in Angstroms after 2x downsampling of the tilt-series
    pixel_spacing = 10.0
    with mrcfile.open(
        model_folder / "projections_unbinned.mrc", permissive=True
    ) as mrc:
        images = torch.tensor(mrc.data)
    images, _ = fourier_rescale_2d(images, 5.0, 10.0)
    ...
    tilt_series = TiltSeries(
        ...
        sample_translations=shifts * -1 * pixel_spacing,
